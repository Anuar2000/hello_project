...
SECRET_KEY = 'django-insecure-us#jut+0b14blooip-^cz#ws#00q)7f5_usq6)j39mgg3!4i&='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "https://hello-project-fl50.onrender.com"]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # <- здесь ищем index.html
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
